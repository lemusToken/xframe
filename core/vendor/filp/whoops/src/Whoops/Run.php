...
class Run
{
    ...
    public function handleException($exception)
    {
        ...
        //for 7.0,eg. Undefined class constant
        if (class_exists('\\Error')&&$exception instanceof \Error) {
            $exception = new ErrorException($exception->getMessage(), /*code*/ $exception->getCode(), /*severity*/ 1, $exception->getFile(), $exception->getLine());
        }
